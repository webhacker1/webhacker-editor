import { LANG_OPTIONS } from "../constants/langOptions.js";
import { createElement, executeCommand, wrapCurrentBlockAs, insertTable } from "../utils/dom.js";
import { saveSelectionRange, restoreSelectionRange, isSelectionInside } from "../utils/selection.js";
import { getCaretOffsetWithin, setCaretOffsetWithin } from "../utils/caret.js";
import { getActiveCodeElement, replaceTextInCode, getCodeLanguage, setCodeLanguage, highlightCodeElement } from "../utils/code.js";
    ...
    this.contentElement.addEventListener("keydown", (e) => {
      ...
      if (isSelectionInside("pre")) {
        ...
        if (!withCmd) {
          ...
          if (key === "enter") { e.preventDefault(); this.insertNewlineInPreWithIndent(); return; }
          const pairs = { "(":")", "{":"}", "[":"]", "\"":"\"", "'":"'", "`":"`" };
