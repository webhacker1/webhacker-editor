...
import { bindMenuKeyboardNavigation, createDropdown, createMenuAction, focusFirstMenuItem } from "@/features/editor/toolbar/toolbarContext";
...
function replacePreWithPlainText(editor, preElement, plainTextValue) {
...
function toggleCodeBlock(editor, language) {
    ...
    if (nearestPreElement) {
        ...
        replacePreWithPlainText(editor, nearestPreElement, plainText);
        return;
    }
