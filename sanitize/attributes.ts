import { TABLE_ALLOWED_CLASS_LIST } from "@/constants/indexConstants";
import { sanitizeStyleAttributeForElement, type SanitizeStyleOptions } from "@/sanitize/styles";
import { normalizeCssColorToHex, sanitizeHref } from "@/sanitize/utils";

export function sanitizeElementAttributes(element: Element, options: SanitizeStyleOptions = {}) {
    [...element.attributes]
